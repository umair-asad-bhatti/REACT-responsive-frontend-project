...
const ProgressBar = ({ mainHeading, perHeading, instruction }) => {
    return (
        <div className='flex md:items-center items-start flex-wrap md:flex-row flex-col justify-between gap-4 overflow-hidden  py-4'>
            ...
            <div className=' md:block hidden w-6 h-6 rounded-full bg-green-800 p-1'>
